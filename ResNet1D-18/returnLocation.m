...
% @Function:Depth-assisted program
% Enter 60 resistivity values, return resistivity value a and location b
% Input: Location information, number of interpolations, interpolated data
% Output: Feature data, number of feature layers
% location indicates the first few samples, number_matrix indicates a value for location, and w is used to return the resistivity
